...
layui.use(['layer', 'form', 'admin', 'ax'], function () {
    ...
    //获取部门信息
    var ajax = new $ax(Feng.ctxPath + "/hierarchy/detail/" + Feng.getUrlParam("deptId"));
    var result = ajax.start();
    form.val('hierarchyForm', result);
    ...
    form.on('submit(btnSubmit)', function (data) {
        var ajax = new $ax(Feng.ctxPath + "/hierarchy/update", function (data) {
            Feng.success("修改成功！");
